...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'imasenfang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '吃猫咪的鱼', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://plastocyanin.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,imasenfang,plastocyanin', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'imasenfang@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/333212375', // B站主页
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://github.com/PrismJS/prism-themes/blob/master/themes/prism-shades-of-purple.css', // 代码块默认主题,https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-okaidia.css
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://github.com/PrismJS/prism-themes/blob/master/themes/prism-shades-of-purple.css', // 浅色模式主题,https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-solarizedlight.css
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://github.com/PrismJS/prism-themes/blob/master/themes/prism-material-oceanic.css', // 深色模式主题
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,twitter,telegram,line,reddit', // 分享的服務，按顺序显示,逗号隔开 ,messenger,whatsapp,linkedin,facebook
